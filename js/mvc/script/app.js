...
// vista.init()
const envarMail = asistentes => 
    console.log("enviando mail a",  asistentes[ asistentes.length -1 ][1] );

const cerrarSala = asistentes => {
    if ( asistentes.length > 10 ) console.log("Sala cerrada");
}
